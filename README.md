...
Con un editor di testo, un "cerca e sostituisci" di `20260818a` su tutto il progetto (compreso `sw.js`) prima di ogni caricamento su Altervista è sufficiente.
